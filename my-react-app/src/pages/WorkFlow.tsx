...
import LogicFlow, { LogicFlow as LogicFlowInstance } from '@logicflow/core'
import '@logicflow/extension/lib/style/index.css'
import data from '../component/Flow/data'
import { DndPanel, SelectionSelect } from '@logicflow/extension';
import '@logicflow/extension/lib/style/index.css'
import { register } from '@logicflow/react-node-registry';
import UserTaskNode from '../component/Flow/useTask';
import {createDndPanelItems} from '../component/Flow/dndOption.ts';
...
const FlowCanvas = () => {
    ...
    const lfRef = useRef<LogicFlowInstance | null>(null)
    ...
    useEffect(() => {
        ...
        const panelItems = createDndPanelItems(lf)
